        ...
        html! {
            ...
            div style="max-width: 600px; padding: 40px; z-index: 100; display: flex; flex-direction: row;
                ...
                div class="card p-6 is-flex is-flex-direction-column is-flex-justify-content-center" style="max-width: 650px; min-width: 500px; width: 100%;" {
                    ...
                    h3 class="title is-size-4 mt-6" {"Login to allgreen"}
                    form hx-post="/auth/send_magic_link" hx-target="this" hx-swap="outerHTML"
                        ...
                        a href="/auth/register" class="button is-ghost mt-2" {"Register"}
                    }
                }
            }}
        },
            ...
            div style="max-width: 600px; padding: 40px; z-index: 100; display: flex; flex-direction: row;
                ...
                div class="card p-6 is-flex is-flex-direction-column is-flex-justify-content-center" style="max-width: 650px; min-width: 500px; width: 100%;" {
                    ...
                    form hx-post="/auth/send_magic_link" hx-target="this" hx-swap="outerHTML"
                        ...
                        a href="/auth/login" class="button is-ghost mt-2" {"Login"}
                    }
                }
            }}
        },
...
pub async fn check(
    ...
    let cookie = format!(
        "allgreen_token={}; HttpOnly; Max-Age={}; SameSite=None; Secure; Path=/",
        token,
        60 * 60 * 24 * 30 * 5
    );
...
async fn logout() -> impl IntoResponse {
    let cookie = format!("allgreen_token=deleted; HttpOnly; SameSite=None; Secure; Path=/");
